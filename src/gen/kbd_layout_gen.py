...
#
# The keyboard layouts, lifted out of src/ria/def/kbd_*.def.
#
...
def parse_manifest(manifest):
    ...
    names = re.findall(r'#\s*include\s+"ria/def/(kbd_[A-Za-z0-9_]+\.def)"', src)
    if not names:
...
HEADER = """/* Generated by src/gen/kbd_layout_gen.py — do not edit.
 *
 ...
 *
 * src/ria/hid/kbl.c takes the record offsets from the header and the
