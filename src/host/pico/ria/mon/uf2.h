...
/* This driver's row in a machine's driver list; see core/driver.h. Writes firmware images to the filesystem. */
#define UF2_DRIVER DRIVER(nul_init, nul_task, uf2_task, nul_run, nul_stop, nul_break)
