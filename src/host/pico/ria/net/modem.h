...
#ifndef _RIA_NET_MODEM_H_
#define _RIA_NET_MODEM_H_
...
#define MODEM_MACH_LIFECYCLE LIFECYCLE(modem_init, modem_task, nul_task, nul_run, modem_stop, nul_break)
