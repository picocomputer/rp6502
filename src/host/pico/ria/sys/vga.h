...
/* This driver's machine-lifecycle row; see core/lifecycle.h. After PIX in the driver list:
...
#define VGA_MACH_LIFECYCLE LIFECYCLE(vga_init, vga_task, nul_task, vga_run, vga_stop, vga_break)
