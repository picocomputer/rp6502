...
/* This driver's row in a machine's driver list; see core/mach.h. First, because the clock
 * it sets is what every later row is timed against. */
#define SYS_DRIVER DRIVER(sys_init, nul_task, nul_task, nul_run, nul_stop, nul_break)
