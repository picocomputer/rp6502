...
int msc_dsk_format_start(uint8_t vol, uint8_t track, uint8_t head); // 0=started, -1=error
int msc_dsk_format_poll(uint8_t vol);    // -1=error, 0..99=percent, 100=track complete
