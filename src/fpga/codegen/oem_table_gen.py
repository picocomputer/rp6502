...
#
# So the data comes here and the logic goes to src/ria/api/uni.c. A
...
HEADER = """/* Generated by src/fpga/codegen/oem_table_gen.py — do not edit.
 *
 ...
 *   then cvt1, then cvt2
 *
 * src/ria/api/uni.c derives every offset from the first four words, so
...
def emit_c(path, words):
    out = [HEADER, '\n#include "oemcp.h"\n#include "ria/api/uni.h"\n\n',
           "static const uint16_t oemcp_data[OEMCP_WORDS] = {\n"]
