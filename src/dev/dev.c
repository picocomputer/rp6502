...
// This module should expand in a way that all kernel devices
// will register here for events instead of main. The monitor
// will become a kernel device and register here too.
