...
#if !defined(UI_DBG_USE_Z80) && !defined(UI_DBG_USE_W65C02)
#error "please define UI_DBG_USE_Z80 or UI_DBG_USE_W65C02"
#endif
...
typedef struct ui_dbg_desc_t {
    ...
    w65c02_t* w65c02;             // 6502 CPU to track
    #endif
