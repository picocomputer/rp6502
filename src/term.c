...
// Classic IBM font for the monitor terminal.
// ASCII glyphs 32-127. 768x16x1 image data.
static const uint8_t __not_in_flash("term_font_data") term_font_data[1536] = {
