 ...
 * PIX driver (ria/sys/pix.h) to compile and run off-target, shadowing the SDK
 * header from this include root like the pico/* shims beside it. The PIX
...
#ifndef _PICO_SHIM_HARDWARE_PIO_H_
#define _PICO_SHIM_HARDWARE_PIO_H_
...
#endif /* _PICO_SHIM_HARDWARE_PIO_H_ */
