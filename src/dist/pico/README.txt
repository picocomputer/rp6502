...
WiFi, Bluetooth, network time, and modem support live:
    ...
    rp6502-@VERSION@-ria-w.uf2    Pi Pico 2 W
    rp6502-@VERSION@-ria.uf2      Pi Pico 2
...
For example, on Windows you might use:
    ...
    COPY rp6502-@VERSION@-ria-w.uf2 X:
    COPY rp6502-@VERSION@-vga.uf2 X:
