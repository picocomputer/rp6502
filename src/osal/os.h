 ...
 * The console this process was launched from is osal/console.h, its own
 * concern because it is the only one here that takes something from the
 * process rather than merely asking the OS a question.
 *
