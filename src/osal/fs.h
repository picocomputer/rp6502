 ...
 * row below, and the OS that implements the seven is what changes --
 * osal/posix/fs.c, osal/windows/fs.c, osal/pico/fs.c and host/pocket/sw/fs.c.
 * Linking a different one is the whole of the seam.
 *
