...
#include "core/emu/sys/ria.h"     /* ria_t, ria_chip, RIA_PIN_*, RIA_MMAP_* */
...
#endif
#include "core/emu/sys/mem.h"      /* ram, xstack_ptr */
#include "core/emu/sys/cpu.h"      /* cpu_get_phi2_khz_run (Status) */
