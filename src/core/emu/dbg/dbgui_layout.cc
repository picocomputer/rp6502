...
extern "C"
{
#include "core/emu/dbg/dbgui.h"        /* dbgui_set_config_file (the public C entry point) */
#include "core/emu/dbg/dbgui_layout.h" /* load/save, host_config_dir, host_ensure_parent_dir */
}
