...
#include "core/emu/emu/pro.h" /* pro_get_exit_code (exit-code display) */
#include "core/emu/main.h"
#include "core/emu/sys/vga.h"
#include "core/emu/emu/via.h"
#include "core/emu/dbg/dbgui.h"        /* the C-callable entry points this TU defines */
#include "core/emu/dbg/dbgui_layout.h" /* ImGui-owned layout persistence (file side) */
#include "core/emu/app/window.h"      /* window-scale presets */
#include "core/emu/emu/rom.h"        /* rom_read_asset (ROM Help viewer) */
}
#include "core/emu/app/credits.h" /* EMU_CREDITS */
#include "core/emu/app/version.h"
#include "core/emu/app/icon.h"    /* icon_desc() - Credits masthead icon */
...
#include "core/emu/app/ui_ria.h"  /* our RIA debug window (bespoke, not a chips fork) */
#include "core/emu/app/ui_ini.h"  /* dummy elements: [RP6502][Launch] + [Window][Manager] */
