...
module tb_pbridge (
    ...
    output logic tb_pbridge_upd_set,
    output logic [15:0] tb_pbridge_upd_id,
    output logic [31:0] tb_pbridge_upd_len,
    input logic reset_n,
    ...
    pocket_bridge bridge (
        ...
        .pocket_bridge_upd_set(tb_pbridge_upd_set),
        .pocket_bridge_upd_id(tb_pbridge_upd_id),
        .pocket_bridge_upd_len(tb_pbridge_upd_len),
        .reset_n(reset_n),
