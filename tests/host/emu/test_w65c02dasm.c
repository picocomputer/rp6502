...
UTEST(w65c02dasm, cmos_stz_tsb_trb_bit)
{
    ...
    CHECK(0x0000, 2, "BIT #$55", 0x89, 0x55);
...
UTEST(w65c02dasm, cmos_zp_indirect)
{
    ...
    CHECK(0x0000, 3, "JMP ($2000,X)", 0x7C, 0x00, 0x20);
}
...
{
    CHECK(0x0000, 1, "NOP", 0xEA);
    CHECK(0x0000, 1, "NOP", 0x03);
    CHECK(0x0000, 1, "NOP", 0xEB);       /* undocumented NMOS SBC immediate */
    CHECK(0x0000, 2, "NOP #$12", 0x02, 0x12);
    CHECK(0x0000, 2, "NOP #$12", 0xE2, 0x12);
    CHECK(0x0000, 2, "NOP $44", 0x44, 0x44);
    CHECK(0x0000, 2, "NOP $44,X", 0x54, 0x44);
    CHECK(0x0000, 3, "NOP $2000", 0x5C, 0x00, 0x20);
...
UTEST(w65c02dasm, base_ops_unchanged)
{
    ...
    CHECK(0x1000, 2, "BNE $0FF0", 0xD0, 0xEE); /* 0x1002 + (-18) */
}
