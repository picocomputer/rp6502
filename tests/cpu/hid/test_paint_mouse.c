 ...
 *
 * 6522 VIA timer-IRQ + mouse integration, driven by paint_mouse.rp6502. Paint maps
 ...
 * mouse.c XRAM mirror. This is the emulator's only IRQ-driven test.
 */
...
UTEST(paint, via_irq_moves_pointer)
{
    ...
    ASSERT_TRUE(mouse_is_mapped()); /* xreg_ria_mouse ran */
