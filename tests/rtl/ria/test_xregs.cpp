...
UTEST(xregs, the_program_reaches_the_devices)
{
    ...
    auto *r = dut->rootp;
    ASSERT_EQ(r->rp6502__DOT__prog__DOT__canvas_shadow, 1);
    ASSERT_EQ(r->rp6502__DOT__prog__DOT__fill_e[0],
              0x80000000u | (3u << 16));
    ASSERT_EQ(r->rp6502__DOT__prog__DOT__fill_c[0], 0x1000);
    ASSERT_EQ(r->rp6502__DOT__prog__DOT__fill_e[239 * 4],
              0x80000000u | (3u << 16));
    ASSERT_EQ(r->rp6502__DOT__prog__DOT__fill_e[240 * 4], 0u);
     ...
     * three M10K to store. */
    ASSERT_EQ(r->rp6502__DOT__prog__DOT__spr_e[100 * 4 + 1],
              (1u << 19) | (4u << 16));
    ASSERT_EQ(r->rp6502__DOT__prog__DOT__spr_c[100 * 4 + 1],
              (3u << 16) | 0x2000u);
    ASSERT_EQ(r->rp6502__DOT__prog__DOT__spr_e[100 * 4 + 2],
              (1u << 19) | (5u << 16) | 10u);
    ASSERT_EQ(r->rp6502__DOT__prog__DOT__spr_c[100 * 4 + 2],
              (2u << 16) | 0x3000u);
}
